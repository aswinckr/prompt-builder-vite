...
export function ContextBlock({ block, isSelected, onSelect, onKeyDown }: ContextBlockProps) {
  ...
  return (
    <button
      ...
      className={`p-4 rounded-lg border transition-all text-left focus:outline-none focus:ring-2 focus:ring-blue-500/50 ${
        isSelected
    ...
    >
      ...
      {/* Content Preview */}
      <p className="text-sm text-neutral-300 line-clamp-3 mb-4 leading-relaxed">
        {block.content}
      </p>
