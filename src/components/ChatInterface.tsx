...
export function ChatInterface({
  ...
  const content = (
    <>
      {/* Overlay backdrop */}
      <div
        className="fixed inset-0 z-overlay-content bg-black/50 backdrop-blur-sm transition-opacity duration-300"
        onClick={handleClose}
        aria-hidden="true"
      />
      ...
      <div
        ref={dialogRef}
        tabIndex={-1}
        className={`fixed right-0 top-0 z-modal flex h-full w-full transform flex-col bg-neutral-900 text-neutral-100 shadow-2xl transition-transform duration-300 ease-in-out outline-none ${
