...
export function VariablePlaceholderHelper() {
  return (
    <div className="mt-2 p-3 rounded-lg bg-purple-500/5 border border-purple-500/10">
      <p className="text-xs text-purple-400 font-medium mb-2">💡 Variable Placeholder Syntax:</p>
      <div className="space-y-2">
        <div className="flex items-center gap-2">
          <span className="text-xs text-neutral-500">Use double curly braces:</span>
          <code className="bg-neutral-700 px-2 py-1 rounded text-xs text-purple-300">{"{{user_name}}"}</code>
          <span className="text-xs text-neutral-500">,</span>
          <code className="bg-neutral-700 px-2 py-1 rounded text-xs text-purple-300">{"{{topic}}"}</code>
          <span className="text-xs text-neutral-500">,</span>
          <code className="bg-neutral-700 px-2 py-1 rounded text-xs text-purple-300">{"{{company}}"}</code>
        </div>
        <div className="text-xs text-neutral-400">
          <p className="font-medium text-purple-300 mb-1">Examples:</p>
